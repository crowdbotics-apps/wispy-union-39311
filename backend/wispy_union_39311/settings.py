"""
Django settings for wispy_union_39311 project.
...
ROOT_URLCONF = 'wispy_union_39311.urls'
...
WSGI_APPLICATION = 'wispy_union_39311.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_union_39311 API",
    "DESCRIPTION": "API documentation for wispy_union_39311 App",
    "VERSION": "v1",
}
